...
# The result of BP is a ocean only-bottom layer appropriate to characterize benthic
# environments
...
# depth classes (0 - 108.03 m depth)
...
# Area is the Coast of the Colombian Pacific Ocean (0 to 108 m depth)
ext = c(-80, -76, 1, 8)
chl1 = crop(chl1,ext)
plot(chl1)
...
# 3.1 Create a reclassification matrix for target depths (0 to 13.9m depth)
...
chl_bottom_jan <- mask(z_chl_bottom_jan, bat_reclass)
plot(chl_bottom_jan)
